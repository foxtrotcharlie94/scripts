...
## ============================================================
##  Combined GSEA sensitivity heatmap — Classical Monocytes
##  Input:  4 CSV files written by gsea_nUMI_sensitivity_monocytes.R
##  Output: GSEA_Master_Sensitivity_Mono_FDR{X}.pdf
##  Requires: ComplexHeatmap, circlize, tidyverse
## ============================================================
...
FDR_CUT <- 0.05   # change to 0.1 or 0.25 as needed
