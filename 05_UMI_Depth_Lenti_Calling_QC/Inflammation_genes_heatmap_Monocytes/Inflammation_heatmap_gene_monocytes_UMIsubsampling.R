...
# Save raw results
write.csv(all_deg, "inflammation_genes_DEG_equalUMI_all_results.csv", row.names=FALSE)
message("\nDEG results saved.")
...
## ── Save ──────────────────────────────────────────────────────────────────────
out_stem <- "Inflammation_genes_heatmap_Monocytes_equalUMI"
...
draw(ht,
     column_title    = paste0("Classical Monocytes — Inflammation genes, UMI-equalised pseudobulk (logFC, FDR < ", FDR_CUT, ")"),
