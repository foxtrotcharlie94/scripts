...
cat("Dimensions:", dim(counts_mono), "\n")
...
seu_mono$lenti_status <- lenti_status
...
# ── 11. Density difference helper function ────────────────────────────────────
